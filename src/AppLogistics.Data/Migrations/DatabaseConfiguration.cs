    ...
    public sealed class DatabaseConfiguration : IDisposable
    {
        ...
        private Permission[] GetSeedPermissions()
        {
            return new Permission[]
            {
                ...
                new Permission { Id = 70, Area = "Configuration", Controller = "Sexes", Action = "Index" },
                new Permission { Id = 71, Area = "Configuration", Controller = "Sexes", Action = "Create" },
                new Permission { Id = 72, Area = "Configuration", Controller = "Sexes", Action = "Details" },
                new Permission { Id = 73, Area = "Configuration", Controller = "Sexes", Action = "Edit" },
                new Permission { Id = 74, Area = "Configuration", Controller = "Sexes", Action = "Delete" },

                new Permission { Id = 75, Area = "Configuration", Controller = "VehicleTypes", Action = "Index" },
                new Permission { Id = 76, Area = "Configuration", Controller = "VehicleTypes", Action = "Create" },
                new Permission { Id = 77, Area = "Configuration", Controller = "VehicleTypes", Action = "Details" },
                new Permission { Id = 78, Area = "Configuration", Controller = "VehicleTypes", Action = "Edit" },
                new Permission { Id = 79, Area = "Configuration", Controller = "VehicleTypes", Action = "Delete" },

                new Permission { Id = 80, Area = "Operation", Controller = "Employees", Action = "Index" },
                new Permission { Id = 81, Area = "Operation", Controller = "Employees", Action = "Create" },
                new Permission { Id = 82, Area = "Operation", Controller = "Employees", Action = "Details" },
                new Permission { Id = 83, Area = "Operation", Controller = "Employees", Action = "Edit" },
                new Permission { Id = 84, Area = "Operation", Controller = "Employees", Action = "Delete" },

                new Permission { Id = 85, Area = "Operation", Controller = "Rates", Action = "Index" },
                new Permission { Id = 86, Area = "Operation", Controller = "Rates", Action = "Create" },
