    ...
    public sealed class DatabaseConfiguration : IDisposable
    {
        ...
        private Permission[] GetSeedPermissions()
        {
            return new Permission[]
            {
                ...
                new Permission { Id = 65, Area = "Configuration", Controller = "Products", Action = "Index" },
                new Permission { Id = 66, Area = "Configuration", Controller = "Products", Action = "Create" },
                new Permission { Id = 67, Area = "Configuration", Controller = "Products", Action = "Details" },
                new Permission { Id = 68, Area = "Configuration", Controller = "Products", Action = "Edit" },
                new Permission { Id = 69, Area = "Configuration", Controller = "Products", Action = "Delete" },

                new Permission { Id = 70, Area = "Configuration", Controller = "Sectors", Action = "Index" },
                new Permission { Id = 71, Area = "Configuration", Controller = "Sectors", Action = "Create" },
                new Permission { Id = 72, Area = "Configuration", Controller = "Sectors", Action = "Details" },
                new Permission { Id = 73, Area = "Configuration", Controller = "Sectors", Action = "Edit" },
                new Permission { Id = 74, Area = "Configuration", Controller = "Sectors", Action = "Delete" },

                new Permission { Id = 75, Area = "Configuration", Controller = "Sexes", Action = "Index" },
                new Permission { Id = 76, Area = "Configuration", Controller = "Sexes", Action = "Create" },
                new Permission { Id = 77, Area = "Configuration", Controller = "Sexes", Action = "Details" },
                new Permission { Id = 78, Area = "Configuration", Controller = "Sexes", Action = "Edit" },
                new Permission { Id = 79, Area = "Configuration", Controller = "Sexes", Action = "Delete" },

                new Permission { Id = 80, Area = "Configuration", Controller = "VehicleTypes", Action = "Index" },
                new Permission { Id = 81, Area = "Configuration", Controller = "VehicleTypes", Action = "Create" },
                new Permission { Id = 82, Area = "Configuration", Controller = "VehicleTypes", Action = "Details" },
                new Permission { Id = 83, Area = "Configuration", Controller = "VehicleTypes", Action = "Edit" },
                new Permission { Id = 84, Area = "Configuration", Controller = "VehicleTypes", Action = "Delete" },

                new Permission { Id = 85, Area = "Operation", Controller = "Employees", Action = "Index" },
                new Permission { Id = 86, Area = "Operation", Controller = "Employees", Action = "Create" },
                new Permission { Id = 87, Area = "Operation", Controller = "Employees", Action = "Details" },
                new Permission { Id = 88, Area = "Operation", Controller = "Employees", Action = "Edit" },
                new Permission { Id = 89, Area = "Operation", Controller = "Employees", Action = "Delete" },

                new Permission { Id = 90, Area = "Operation", Controller = "Rates", Action = "Index" },
                new Permission { Id = 91, Area = "Operation", Controller = "Rates", Action = "Create" },
                new Permission { Id = 92, Area = "Operation", Controller = "Rates", Action = "Details" },
                new Permission { Id = 93, Area = "Operation", Controller = "Rates", Action = "Edit" },
                new Permission { Id = 94, Area = "Operation", Controller = "Rates", Action = "Delete" },

                new Permission { Id = 95, Area = "Operation", Controller = "Services", Action = "Index" },
                new Permission { Id = 96, Area = "Operation", Controller = "Services", Action = "Create" },
                new Permission { Id = 97, Area = "Operation", Controller = "Services", Action = "Details" },
                new Permission { Id = 98, Area = "Operation", Controller = "Services", Action = "Edit" },
                new Permission { Id = 99, Area = "Operation", Controller = "Services", Action = "Delete" },

                new Permission { Id = 100, Area = "Reporting", Controller = "ServiceReports", Action = "Query" },
                new Permission { Id = 101, Area = "Reporting", Controller = "ServiceReports", Action = "QueryResult" },
                new Permission { Id = 102, Area = "Reporting", Controller = "ServiceReports", Action = "Details" },
                new Permission { Id = 103, Area = "Reporting", Controller = "ServiceReports", Action = "ExportExcel" },
            };
        }
    }
}
