    ...
    public sealed class DatabaseConfiguration : IDisposable
    {
        ...
        private Permission[] GetSeedPermissions()
        {
            return new Permission[]
            {
                ...
                new Permission { Id = 35, Area = "Configuration", Controller = "DocumentTypes", Action = "Index" },
                new Permission { Id = 36, Area = "Configuration", Controller = "DocumentTypes", Action = "Create" },
                new Permission { Id = 37, Area = "Configuration", Controller = "DocumentTypes", Action = "Details" },
                new Permission { Id = 38, Area = "Configuration", Controller = "DocumentTypes", Action = "Edit" },
                new Permission { Id = 39, Area = "Configuration", Controller = "DocumentTypes", Action = "Delete" },

                new Permission { Id = 40, Area = "Configuration", Controller = "EducationLevels", Action = "Index" },
                new Permission { Id = 41, Area = "Configuration", Controller = "EducationLevels", Action = "Create" },
                new Permission { Id = 42, Area = "Configuration", Controller = "EducationLevels", Action = "Details" },
                new Permission { Id = 43, Area = "Configuration", Controller = "EducationLevels", Action = "Edit" },
                new Permission { Id = 44, Area = "Configuration", Controller = "EducationLevels", Action = "Delete" },

                new Permission { Id = 45, Area = "Configuration", Controller = "Epss", Action = "Index" },
                new Permission { Id = 46, Area = "Configuration", Controller = "Epss", Action = "Create" },
                new Permission { Id = 47, Area = "Configuration", Controller = "Epss", Action = "Details" },
                new Permission { Id = 48, Area = "Configuration", Controller = "Epss", Action = "Edit" },
                new Permission { Id = 49, Area = "Configuration", Controller = "Epss", Action = "Delete" },

                new Permission { Id = 50, Area = "Configuration", Controller = "EthnicGroups", Action = "Index" },
                new Permission { Id = 51, Area = "Configuration", Controller = "EthnicGroups", Action = "Create" },
                new Permission { Id = 52, Area = "Configuration", Controller = "EthnicGroups", Action = "Details" },
                new Permission { Id = 53, Area = "Configuration", Controller = "EthnicGroups", Action = "Edit" },
                new Permission { Id = 54, Area = "Configuration", Controller = "EthnicGroups", Action = "Delete" },

                new Permission { Id = 55, Area = "Configuration", Controller = "MaritalStatuses", Action = "Index" },
                new Permission { Id = 56, Area = "Configuration", Controller = "MaritalStatuses", Action = "Create" },
                new Permission { Id = 57, Area = "Configuration", Controller = "MaritalStatuses", Action = "Details" },
                new Permission { Id = 58, Area = "Configuration", Controller = "MaritalStatuses", Action = "Edit" },
                new Permission { Id = 59, Area = "Configuration", Controller = "MaritalStatuses", Action = "Delete" },

                new Permission { Id = 60, Area = "Configuration", Controller = "Products", Action = "Index" },
                new Permission { Id = 61, Area = "Configuration", Controller = "Products", Action = "Create" },
                new Permission { Id = 62, Area = "Configuration", Controller = "Products", Action = "Details" },
                new Permission { Id = 63, Area = "Configuration", Controller = "Products", Action = "Edit" },
                new Permission { Id = 64, Area = "Configuration", Controller = "Products", Action = "Delete" },

                new Permission { Id = 65, Area = "Configuration", Controller = "VehicleTypes", Action = "Index" },
                new Permission { Id = 66, Area = "Configuration", Controller = "VehicleTypes", Action = "Create" },
                new Permission { Id = 67, Area = "Configuration", Controller = "VehicleTypes", Action = "Details" },
                new Permission { Id = 68, Area = "Configuration", Controller = "VehicleTypes", Action = "Edit" },
                new Permission { Id = 69, Area = "Configuration", Controller = "VehicleTypes", Action = "Delete" },

                new Permission { Id = 70, Area = "Operation", Controller = "Employees", Action = "Index" },
                new Permission { Id = 71, Area = "Operation", Controller = "Employees", Action = "Create" },
                new Permission { Id = 72, Area = "Operation", Controller = "Employees", Action = "Details" },
                new Permission { Id = 73, Area = "Operation", Controller = "Employees", Action = "Edit" },
                new Permission { Id = 74, Area = "Operation", Controller = "Employees", Action = "Delete" },

                new Permission { Id = 75, Area = "Operation", Controller = "Rates", Action = "Index" },
                new Permission { Id = 76, Area = "Operation", Controller = "Rates", Action = "Create" },
                new Permission { Id = 77, Area = "Operation", Controller = "Rates", Action = "Details" },
                new Permission { Id = 78, Area = "Operation", Controller = "Rates", Action = "Edit" },
                new Permission { Id = 79, Area = "Operation", Controller = "Rates", Action = "Delete" },
            };
        }
    }
}
