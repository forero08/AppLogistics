    ...
    public sealed class DatabaseConfiguration : IDisposable
    {
        ...
        private Permission[] GetSeedPermissions()
        {
            return new Permission[]
            {
                ...
                new Permission { Id = 45, Area = "Configuration", Controller = "MaritalStatuses", Action = "Index" },
                new Permission { Id = 46, Area = "Configuration", Controller = "MaritalStatuses", Action = "Create" },
                new Permission { Id = 47, Area = "Configuration", Controller = "MaritalStatuses", Action = "Details" },
                new Permission { Id = 48, Area = "Configuration", Controller = "MaritalStatuses", Action = "Edit" },
                new Permission { Id = 49, Area = "Configuration", Controller = "MaritalStatuses", Action = "Delete" },

                new Permission { Id = 50, Area = "Configuration", Controller = "Products", Action = "Index" },
                new Permission { Id = 51, Area = "Configuration", Controller = "Products", Action = "Create" },
                new Permission { Id = 52, Area = "Configuration", Controller = "Products", Action = "Details" },
                new Permission { Id = 53, Area = "Configuration", Controller = "Products", Action = "Edit" },
                new Permission { Id = 54, Area = "Configuration", Controller = "Products", Action = "Delete" },

                new Permission { Id = 55, Area = "Configuration", Controller = "VehicleTypes", Action = "Index" },
                new Permission { Id = 56, Area = "Configuration", Controller = "VehicleTypes", Action = "Create" },
                new Permission { Id = 57, Area = "Configuration", Controller = "VehicleTypes", Action = "Details" },
                new Permission { Id = 58, Area = "Configuration", Controller = "VehicleTypes", Action = "Edit" },
                new Permission { Id = 59, Area = "Configuration", Controller = "VehicleTypes", Action = "Delete" },

                new Permission { Id = 60, Area = "Operation", Controller = "Employees", Action = "Index" },
                new Permission { Id = 61, Area = "Operation", Controller = "Employees", Action = "Create" },
                new Permission { Id = 62, Area = "Operation", Controller = "Employees", Action = "Details" },
                new Permission { Id = 63, Area = "Operation", Controller = "Employees", Action = "Edit" },
                new Permission { Id = 64, Area = "Operation", Controller = "Employees", Action = "Delete" },

                new Permission { Id = 65, Area = "Operation", Controller = "Rates", Action = "Index" },
                new Permission { Id = 66, Area = "Operation", Controller = "Rates", Action = "Create" },
                new Permission { Id = 67, Area = "Operation", Controller = "Rates", Action = "Details" },
                new Permission { Id = 68, Area = "Operation", Controller = "Rates", Action = "Edit" },
                new Permission { Id = 69, Area = "Operation", Controller = "Rates", Action = "Delete" },
            };
        }
    }
}
